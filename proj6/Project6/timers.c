...
//project 6
extern unsigned volatile int p6act;
extern unsigned volatile int p6timer;
...
extern unsigned volatile int waittime;
unsigned volatile int gotime = 0;

char hexToBCD[10] = {0x20, 0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20};
